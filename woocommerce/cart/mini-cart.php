...
<?php } ?>
<p class="widget_minicart_title"><?php esc_html_e( '장바구니', 'amely' ); ?>
	<a href="#" class="close-on-mobile hidden-xl-up">&times;</a>
	<span class="undo">
						<?php esc_html_e( '아이템 삭제됨.', 'amely' ) ?>
		<a href="#"><?php esc_html_e( '취소', 'amely' ); ?></a>
					</span>
</p>
<ul class="woocommerce-mini-cart cart_list product_list_widget <?php echo esc_attr( $args['list_class'] ); ?>">

	<li class="woocommerce-mini-cart__empty-message empty<?php echo WC()->cart->is_empty() ? '' : ' hidden'; ?>"><?php esc_html_e( '아직 장바구니가 비어있습니다.',
			'amely' ); ?></li>
...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<p class="woocommerce-mini-cart__total total"><strong><?php esc_html_e( '합계', 'amely' ); ?>
	...
	<p class="woocommerce-mini-cart__buttons buttons">
		<a href="<?php echo esc_url( wc_get_cart_url() ); ?>"
		   class="button wc-forward"><?php esc_html_e( '장바구니 보기', 'amely' ); ?></a>
		<a href="<?php echo esc_url( wc_get_checkout_url() ); ?>"
		   class="button checkout alt-button wc-forward"><?php esc_html_e( '구매하기', 'amely' ); ?></a>
	</p>
